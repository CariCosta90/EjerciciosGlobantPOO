...
public class Ejercicio8 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ingresa el caracter a ser buscado: ");
        String letra = leer.next();
        cs.vecesRepetido(c1, letra);

        System.out.println("Ingresa una frase para comparar");

        String nuevaFrase = leer.next();
        cs.comprarLongitud(c1, nuevaFrase);

        System.out.println("Ingresa una frase para concatenar");
        String fraseConcatenar = leer.next();
        cs.unirFrases(c1, fraseConcatenar);
        
        System.out.println("Ingresa el caracter para sustituir las lestras 'a': ");
        String caracter = leer.next();
        cs.reemplazar(c1, caracter);
        
        System.out.println("Ingresa el caracter a ser buscado: ");
        String otraLetra = leer.next();
        System.out.println("Se encuentra el caracter ingresado en la frase? " + cs.contiene(c1, otraLetra));
